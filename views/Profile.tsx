    ...
    return (
        <div className="w-full h-full bg-transparent p-4 md:p-8 overflow-y-auto">
            <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                {/* Header */}
                <div className="mb-8">
                    <h2 className="text-3xl font-bold text-white mb-2 tracking-tight drop-shadow-md">{t.operatorProfile}</h2>
                ...
                <div className="bg-[#0e0e11]/60 backdrop-blur-xl rounded-2xl border border-white/5 p-6">
                    ...
                    <div className="space-y-4">
                        <button
                            onClick={() => {
                                setConfirmTitle(t.clearUsageCountsTitle);
                                setConfirmMessage(t.clearUsageCountsMessage);
                        ...
                        <button
                            onClick={() => {
                                setConfirmTitle(t.resetUserDataTitle);
                                setConfirmMessage(t.resetUserDataMessage);
